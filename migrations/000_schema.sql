...
-- ============================================================
-- TABLE: assessment_retry_queue
-- Tracks retry queue for failed LLM assessments
-- ============================================================

CREATE TABLE IF NOT EXISTS assessment_retry_queue (
...
CREATE INDEX IF NOT EXISTS idx_assessment_retry_queue_status ON assessment_retry_queue(status);
CREATE INDEX IF NOT EXISTS idx_assessment_retry_queue_report_id ON assessment_retry_queue(report_id);

-- ============================================================
-- TABLE: shared_filters
-- Stores shared filter configurations
-- ============================================================

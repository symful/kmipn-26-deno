...
import { categorySubtreeRoute } from "@/routes/api/categories/[id]/subtree";
...
import { authValidateRoleRoute } from "@/routes/api/auth/validate-role";
...
import { publicSyncBatchRoute } from "@/routes/api/public/sync-batch";
...
import { retryFailedAssessmentsRoute, processFailedAssessments } from "@/routes/api/cron/retry-failed-assessments";
import { cleanupRevokedTokensRoute, cleanupRevokedTokens } from "@/routes/api/cron/cleanup-revoked-tokens";
...
import { adminSyncKpiRoute } from "@/routes/api/admin/sync-kpi";
...
import { kpiSyncSuccessRoute } from "@/routes/api/admin/kpis/sync-success";
import { kpiVerificationDurationRoute } from "@/routes/api/admin/kpis/verification-duration";
import { kpiAdoptionRoute } from "@/routes/api/admin/kpis/adoption-rate";
...
import { syncKpiSummaryRoute } from "@/routes/api/sync-kpi/summary";
import { reportImpactRoute } from "@/routes/api/reports/[id]/impact";
import { surveyorTasksDownloadBatchRoute } from "@/routes/api/surveyor/tasks/download-batch";
...
import { agentConsolidateRoute } from "@/routes/api/agent/consolidate";
import { facilitiesIndexRoute } from "@/routes/api/facilities";
import { facilitiesDetailRoute } from "@/routes/api/facilities/[id]";
import { facilitiesMergeRoute } from "@/routes/api/facilities/[id]/merge";
import { facilitiesSplitRoute } from "@/routes/api/facilities/[id]/split";

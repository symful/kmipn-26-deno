...
import fieldEvidenceTool from "./fieldEvidence";

export const allTools = {
  collect_field_evidence: fieldEvidenceTool,
...
export type {
  LocationTimeConsistencyInput,
  LocationTimeConsistencyOutput,
} from "./locationTimeConsistency";
export type {
  ClassifyProblemInput,
  ClassifyProblemOutput,
...
export type {
  AnalyzeImageVisionInput,
  AnalyzeImageVisionOutput,
} from "./analyzeImageVision";

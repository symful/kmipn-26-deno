...
Kembalikan hanya JSON valid tanpa markdown atau teks tambahan.`;
  ...
  inputSchema: mediaQualityInputSchema,
  ...
  execute: async (
    ...
    try {
      ...
      await saveAssessment(env, {
        ...
        status: "completed",
        result: { ...llmResult, correlation_ids },
      });

      return { ...llmResult, correlation_ids };
    } catch (e) {

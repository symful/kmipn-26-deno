...
import { sidebarBg, sidebarText, colors } from '../../theme/tokens';

interface BrowserChromeProps {
  /** Current route path to display in URL bar (e.g., "/dashboard", "/operator/queue") */
  currentRoute?: string;
 ...
 * Used in operator dashboard to simulate a browser-like interface.
 *
 * @example
 * ```tsx
 * <BrowserChrome currentRoute="/operator/queue" />
 * <BrowserChrome title="PantauDesa - Dashboard" />
 * ```
 */

/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 64e5e2b94b35ac221231549623ece430)
// Runtime types generated with workerd@1.20260801.1 2026-08-08 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	WILAYAH_KABUPATEN_ID?: "00000000-0000-0000-0000-000000000001" | "00000000-0000-0000-0000-000000000002" | "00000000-0000-0000-0000-000000000003";
	DEPLOY_REGION?: "kabupaten-a" | "kabupaten-b" | "kabupaten-c";
	PILOT_NAME?: "Pilot Kabupaten A" | "Pilot Kabupaten B" | "Pilot Kabupaten C";
	TOOL_TIMEOUT_MS: string;
	MAX_RETRIES: string;
	LOCATION_TOLERANCE_METERS: string;
	TIME_TOLERANCE_HOURS: string;
	DUPLICATE_RADIUS_METERS: string;
	DUPLICATE_LIMIT: string;
	SLA_DEFAULT_DAYS: string;
	SHARE_TOKEN_EXPIRY_HOURS: string;
	OUTBOX_MAX_RETRIES: string;
	OUTBOX_RETRY_DELAYS_MINUTES: string;
	FAILED_ASSESSMENTS_BATCH_LIMIT: string;
...
declare namespace Cloudflare {
	...
	interface PilotKabupatenAEnv {
		ASSETS: Fetcher;
		WILAYAH_KABUPATEN_ID: "00000000-0000-0000-0000-000000000001";
		DEPLOY_REGION: "kabupaten-a";
		PILOT_NAME: "Pilot Kabupaten A";
		TOOL_TIMEOUT_MS: string;
		MAX_RETRIES: string;
		LOCATION_TOLERANCE_METERS: string;
		TIME_TOLERANCE_HOURS: string;
	...
	interface PilotKabupatenBEnv {
		ASSETS: Fetcher;
		WILAYAH_KABUPATEN_ID: "00000000-0000-0000-0000-000000000002";
		DEPLOY_REGION: "kabupaten-b";
		PILOT_NAME: "Pilot Kabupaten B";
		TOOL_TIMEOUT_MS: string;
		MAX_RETRIES: string;
		LOCATION_TOLERANCE_METERS: string;
		TIME_TOLERANCE_HOURS: string;
	...
	interface PilotKabupatenCEnv {
		ASSETS: Fetcher;
		WILAYAH_KABUPATEN_ID: "00000000-0000-0000-0000-000000000003";
		DEPLOY_REGION: "kabupaten-c";
		PILOT_NAME: "Pilot Kabupaten C";
		TOOL_TIMEOUT_MS: string;
		MAX_RETRIES: string;
		LOCATION_TOLERANCE_METERS: string;
		TIME_TOLERANCE_HOURS: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WILAYAH_KABUPATEN_ID" | "DEPLOY_REGION" | "PILOT_NAME" | "TOOL_TIMEOUT_MS" | "MAX_RETRIES" | "LOCATION_TOLERANCE_METERS" | "TIME_TOLERANCE_HOURS" | "DUPLICATE_RADIUS_METERS" | "DUPLICATE_LIMIT" | "SLA_DEFAULT_DAYS" | "SHARE_TOKEN_EXPIRY_HOURS" | "OUTBOX_MAX_RETRIES" | "OUTBOX_RETRY_DELAYS_MINUTES" | "FAILED_ASSESSMENTS_BATCH_LIMIT" | "OUTBOUND_TARGETS" | "OUTBOUND_HMAC_SECRET" | "OUTBOUND_HMAC_HEADER" | "SIPD_ENDPOINT_URL" | "SIPD_HMAC_SECRET" | "SATU_DATA_ENDPOINT_URL" | "SATU_DATA_TOKEN" | "WEBHOOK_SECRET" | "APP_BASE_URL" | "CF_REPORTING_DOMAIN" | "RATE_LIMIT_ENABLED" | "DISABLE_LOGIN_AUDIT" | "ENVIRONMENT" | "ALLOWED_ORIGINS" | "TEXT_MODEL_NAME" | "VISION_MODEL_NAME" | "R2_PUBLIC_URL" | "POSTGRESQL_URI" | "LLM_API_URI" | "LLM_API_KEY" | "JWT_SECRET" | "TEST_RESET_SECRET" | "ENABLE_TEST_RESET" | "PGPASSWORD" | "HOME">> {}
}
